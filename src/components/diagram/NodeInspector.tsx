    ...
    <div className="absolute top-24 right-8 z-20 w-80 bg-white border-2 border-[#2D2D2D] p-6 shadow-[8px_8px_0px_#2D2D2D] rounded-xl animate-in fade-in slide-in-from-right-6 duration-300 font-sans text-[#2D2D2D]">
      ...
      <div className="space-y-6">
        <div className="space-y-2.5">
          <Label htmlFor="node-label" className="text-[10px] uppercase font-semibold tracking-widest text-[#2D2D2D] opacity-80 px-1">Display Label</Label>
          <Input
            id="node-label"
        ...
        <div className="space-y-3 p-3 border-2 border-[#2D2D2D] rounded-lg bg-gray-50/50">
          <Label className="text-[10px] uppercase font-semibold tracking-widest text-[#2D2D2D] opacity-80 px-1">Traffic Roles</Label>
        ...
        <div className="space-y-2.5">
          <Label className="text-[10px] uppercase font-semibold tracking-widest text-[#2D2D2D] opacity-80 px-1">Visual Icon</Label>
