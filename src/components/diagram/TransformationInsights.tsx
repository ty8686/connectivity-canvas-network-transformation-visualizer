...
import { Info, Zap, TrendingDown, Target } from 'lucide-react';
        ...
        <div className="p-8 space-y-8 bg-white text-[#2D2D2D]">
          <DialogHeader>
            ...
            <DialogDescription className="text-muted-foreground text-sm pt-2 font-medium">
              A comprehensive comparison of performance metrics between your current {mode} architecture and the Cloudflare Connectivity Cloud.
            </DialogDescription>
          </DialogHeader>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-4">
              ...
              <div className="p-5 rounded-lg border-2 border-slate-100 bg-slate-50/50">
                <ul className="space-y-3">
                  ...
                  <li className="flex justify-between items-center text-sm">
                    <span className="font-bold">Total Hops</span>
                  ...
                  <li className="flex justify-between items-center text-sm">
                    ...
                    <span className="font-black text-[#2D2D2D]">{mode === 'legacy' ? 'Decentralized' : 'Edge-First'}</span>
                  </li>
                </ul>
              </div>
            </div>
            <div className="space-y-4">
              <h4 className="text-[10px] font-black uppercase tracking-widest text-[#F38020] px-1">Target Cloudflare Edge</h4>
              <div className={cn(
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex justify-between items-center text-sm">
                    <span className="font-bold">Network Hops</span>
                    <span className="font-black text-green-600">1 (Unified)</span>
                  </li>
                  <li className="flex justify-between items-center text-sm">
                    <span className="font-bold">Security</span>
                    <span className="font-black text-[#F38020]">Zero Trust</span>
                  </li>
                </ul>
              </div>
            </div>
          </div>
          <div className="bg-blue-50 border-2 border-blue-100 p-6 rounded-xl relative overflow-hidden">
            <h4 className="font-black text-[11px] uppercase tracking-tighter text-blue-900 mb-4 flex items-center gap-2 relative z-10">
            ...
            <div className="grid grid-cols-3 gap-6 relative z-10">
              <div className="text-center">
                ...
                <div className="text-[9px] uppercase font-black text-blue-900/60 mt-1">Reduced Latency</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-black text-blue-600 tracking-tighter">{hopsDelta}x</div>
                <div className="text-[9px] uppercase font-black text-blue-900/60 mt-1">Faster Traversal</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-black text-blue-600 tracking-tighter">0</div>
                <div className="text-[9px] uppercase font-black text-blue-900/60 mt-1">Appliance Overhead</div>
              </div>
            </div>
          </div>
          <div className="flex justify-between items-center pt-2">
            <p className="text-[10px] text-muted-foreground font-bold uppercase tracking-widest max-w-[200px]">
              Calculated based on global edge performance averages.
            </p>
            <DialogClose asChild>
