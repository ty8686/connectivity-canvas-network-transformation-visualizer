  ...
  return (
    <div className="absolute top-24 right-8 z-20 w-80 bg-white border border-[#2D2D2D] p-6 shadow-2xl rounded-xl animate-in fade-in slide-in-from-right-6 duration-300 font-sans text-[#2D2D2D]">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h3 className="text-lg font-bold tracking-tight text-[#2D2D2D]">Edge Link</h3>
          <p className="text-[10px] text-[#2D2D2D] opacity-50 font-mono uppercase">ID: {edge.id.slice(0, 8)}</p>
        </div>
      ...
      <div className="space-y-6">
        <div className="space-y-2.5">
          <Label htmlFor="edge-label" className="text-[10px] uppercase font-black tracking-widest text-[#2D2D2D] opacity-70 px-1">Link Label</Label>
          <Input
            id="edge-label"
            value={edgeLabel}
        ...
        <div className="space-y-4">
          <div className="flex justify-between items-center px-1">
            <Label className="text-[10px] uppercase font-black tracking-widest text-[#2D2D2D] opacity-70">Latency Weight</Label>
          ...
          <Slider
            ...
            className="py-4"
          />
          <div className="flex justify-between text-[10px] font-bold text-[#2D2D2D] opacity-40 uppercase px-1">
            <span>Fast</span>
            <span>Congested</span>
          </div>
        </div>
